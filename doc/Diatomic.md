...
![](https://latex.codecogs.com/svg.latex?{\color{Red}&space;}\mathbf{H}&space;=&space;\mathbf{T}_{\mathrm{N}}(R)&space;&plus;&space;\mathbf{H}_{\mathrm{rot}}(R,&space;\theta,&space;\phi)&space;&plus;&space;\mathbf{T}_{\mathrm{e}}(r)&space;&plus;&space;\mathbf{V}(R,&space;r)&space;&plus;&space;\mathbf{H}_{\mathrm{rel}})
